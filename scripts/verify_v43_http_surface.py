    ...
    try:
        with socketserver.TCPServer(('127.0.0.1',0),Q) as srv:
            ...
            checks={
                ...
                '/explore.html':['Seven worlds. One connected field.','mobile-navigation'],
                '/lab.html':['Change an input. Watch the system reorganize.'],
                '/evidence.html':['Marketing claims should','Evidence &amp; history'],
                '/pramana/':['If your business uses people’s data, DPDP may apply.','Reviewed for controlled commercial outreach.'],
                '/pramana/sources/':['G.S.R. 843(E)','MEITY LISTING'],
                '/pramana/demos/dpdp-check/':['See your notes first, with no sign-up.','not a legal pass/fail test.'],
