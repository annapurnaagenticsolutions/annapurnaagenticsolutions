...
def main()->int:
    profile=json.loads((ROOT/'data/release-profile.json').read_text());assert profile['release']=='2.5'
    for script in [
    ...
    print('PASS v2.5 release audit: inherited causal chains + emergent composite scenes + prior living-world contracts')
    return 0
