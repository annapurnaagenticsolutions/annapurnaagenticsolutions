...
def main():
    profile=json.loads((ROOT/'data/release-profile.json').read_text());assert profile['release']=='3.8'
    ...
    print('PASS v3.8 release audit: optical material + semantic type + evidence field + inherited contracts + budgets')
    return 0
