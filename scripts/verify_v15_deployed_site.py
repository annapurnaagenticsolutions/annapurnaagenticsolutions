...
checks={
 ...
 'assets/site.css':'v1.5 — temporal + sensory living layer',
 'assets/site.js':'annapurnaLivingV15',
 'data/evidence-manifest.json':'"claims"',
 'data/repository-signals.json':'"repositories"',
 'data/public-history.json':'"entries"',
 'data/release-profile.json':'"release": "1.5"',
...
for path,marker in checks.items():
    ...
    print('PASS',url)
print('PASS deployed v1.5 adaptive + temporal + sensory living surface')
