...
checks={
 'index.html':['v3-story-shell','data-word-world="connected">Connected.</span>','v3-route-overlay'],
 ...
 'assets/site.css':['--type-h1','--type-h2','--type-h3','scroll-margin-top:92px'],
 'data/release-profile.json':['"release": "3.7"'],
 'data/living-world-v37.json':['"release": "3.7"','"singleH1TokenAcrossHomeExploreLabEvidence404": true']
}
errors=[]
...
print('PASS deployed v3.7 typographic system lock + visual QA contract')
