...
def main():
    profile=json.loads((ROOT/'data/release-profile.json').read_text());assert profile['release']=='3.4'
    ...
    print('PASS v3.4 release audit: Journey frame ownership + v3.3 motion/material engine + prior contracts + budgets')
    return 0
