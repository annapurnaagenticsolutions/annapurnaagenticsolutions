...
def main():
    profile=json.loads((ROOT/'data/release-profile.json').read_text());assert profile['release']=='4.2'
    ...
    print('PASS v4.2 release audit: company integration + inherited contracts + static budgets')
    return 0
