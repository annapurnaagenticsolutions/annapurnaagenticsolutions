...
def main():
    profile=json.loads((ROOT/'data/release-profile.json').read_text());assert profile['release']=='3.1'
    ...
    print('PASS v3.1 release audit: correction-only presentation + prior living engine + budgets')
    return 0
