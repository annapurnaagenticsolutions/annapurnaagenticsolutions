...
def main()->int:
    profile=json.loads((ROOT/'data/release-profile.json').read_text());assert profile['release']=='2.2'
    for script in [
    ...
    print('PASS v2.2 release audit: contracts + copy + performance + JS + semantic-depth/world-signature layer')
    return 0
