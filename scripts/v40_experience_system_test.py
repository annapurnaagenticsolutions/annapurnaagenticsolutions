...
def main():
 ...
 for token in ['page-context-ribbon','evidence-focus-shell','evidence-toolbar','page-arrive','field-breathe-atlas']:
 ...
 assert 'body.page-leaving:after' not in css and "document.body.classList.add('page-leaving')" not in js
