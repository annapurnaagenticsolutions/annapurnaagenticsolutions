...
def main()->int:
    profile=json.loads((ROOT/'data/release-profile.json').read_text());assert profile['release']=='2.3'
    for script in [
      ...
      'v23_micro_scene_contract_test.py','public_copy_audit.py','comprehension_audit.py',
    ...
    print('PASS v2.3 release audit: six ephemeral topology micro-scenes + prior living-world contracts')
    return 0
