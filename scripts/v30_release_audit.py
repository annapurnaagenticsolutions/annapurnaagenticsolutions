...
def main()->int:
    profile=json.loads((ROOT/'data/release-profile.json').read_text());assert profile['release']=='3.0'
    for script in [
      ...
      'v25_composite_scene_contract_test.py','v25_ephemerality_test.py',
      'v30_experience_reconstruction_test.py','public_copy_audit.py','comprehension_audit.py',
    ...
    print('PASS v3.0 release audit: reconstructed presentation + living engine + budgets')
    return 0
